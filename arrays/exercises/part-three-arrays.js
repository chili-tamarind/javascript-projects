let cargoHold_1 = [1138, 'space suits', 'parrot', 'instruction manual', 'meal packs', 'space tether', '20 meters'];
console.log(cargoHold_1);
...
cargoHold.splice(3,0,'keys'); // 0 means not replacing entries
