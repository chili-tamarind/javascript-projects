...
const printAll = require('./display.js');                     //Import function from display.js >>>>>>>> same folder
...
/* OBJECTS: Inside a for..in loop, we can only use bracket syntax to access the property values. */
